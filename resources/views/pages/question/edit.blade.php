        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Change Question</div>
                </div>
            </div>
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="selectgroup w-100">
                                            ...
                                            <label class="selectgroup-item">
                                                <input type="radio"
                                                    ...
                                                    value="Verbal"
                                                    class="selectgroup-input"
                                                    @if ($question->kategori == 'Verbal') checked @endif>
                                            ...
                                            <label class="selectgroup-item">
                                                <input type="radio"
                                                    ...
                                                    value="Logika"
                                                    class="selectgroup-input"
                                                    @if ($question->kategori == 'Logika') checked @endif>
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <textarea class="form-control"
                                            ...
                                            is-invalid
                                        @enderror"
                                            name="pertanyaan">{{ $question->pertanyaan }}</textarea>
                                            @error('pertanyaan')
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <textarea class="form-control"
                                            ...
                                            is-invalid
                                        @enderror"
                                            name="jawaban_a">{{ $question->jawaban_a }}</textarea>
                                            @error('jawaban_a')
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <textarea class="form-control"
                                            ...
                                            is-invalid
                                        @enderror"
                                            name="jawaban_b">{{ $question->jawaban_b }}</textarea>
                                            @error('jawaban_b')
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <textarea class="form-control"
                                            ...
                                            is-invalid
                                        @enderror"
                                            name="jawaban_c">{{ $question->jawaban_c }}</textarea>
                                            @error('jawaban_c')
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <textarea class="form-control"
                                            ...
                                            is-invalid
                                        @enderror"
                                            name="jawaban_d">{{ $question->jawaban_d }}</textarea>
                                            @error('jawaban_d')
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
                                        ...
                                        <div class="selectgroup w-100">
                                            <label class="selectgroup-item">
                                                <input type="radio"
                                                    ...
                                                    value="a"
                                                    class="selectgroup-input"
                                                    @if ($question->kunci == 'a') checked @endif>
                                            ...
                                            <label class="selectgroup-item">
                                                <input type="radio"
                                                    ...
                                                    value="b"
                                                    class="selectgroup-input"
                                                    @if ($question->kunci == 'b') checked @endif>
                                            ...
                                            <label class="selectgroup-item">
                                                <input type="radio"
                                                    ...
                                                    value="c"
                                                    class="selectgroup-input"
                                                    @if ($question->kunci == 'c') checked @endif>
                                            ...
                                            <label class="selectgroup-item">
                                                <input type="radio"
                                                    ...
                                                    value="d"
                                                    class="selectgroup-input"
                                                    @if ($question->kunci == 'd') checked @endif>
